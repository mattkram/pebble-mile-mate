...
#define PIN_WINDOW_HEIGHT 34
#define PIN_WINDOW_MAX_WIDTH 128
#define PIN_WINDOW_CELL_PADDING 4
...
void pin_window_set_title(PinWindow*, char*);
...
/*
 * Returns the integer representation of the provided pin.
 */
